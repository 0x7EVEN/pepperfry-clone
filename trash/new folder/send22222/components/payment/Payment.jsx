...
function Payment() {
    ...
    return (<>
        ...
        <Navdiv>
                ...
                <div className="two">
                    <p>
                         <img src="https://th.bing.com/th/id/OIP.hfixL5WZFsUKi6RLwMNlkQAAAA?pid=ImgDet&w=414&h=400&rs=1" alt="something" style={{maxWidth:"25px",marginLeft:"6.5%",float:"left"}}/><br/><span>Cart-----Delivery & Billing Address </span>--------payment
            ...
            <Ordermain>
                <div className="address">
                    <div className="one">
                        <p style={{textAlign:"left"}}>ORDER SUMMARY <span>(items)<button onClick={handleOrder}>{order? "-":"+" }</button></span></p>
                    </div>
                    <div style={order?{display:"block"}:{display:"none"}}>
                        <div style={{display:"grid",rowGap:"1.1%"}}>
                            {cart ? cart.map((el)=>{
                                return <div style={{display:"flex"}}>
                                    <img style={{width:"100px",height:"70px"}} src={el.data.colorImage[0].images[0]} alt="something"/>
                                    <div style={{marginLeft:"1%"}}>{el.data.name}<br/><p>Delivery By<br/>Rs {el.data.disPrice}</p></div>
                                </div>
                            })
                            : <div>..loading</div>}
                        </div>
                    ...
                    <div className="one">
                        <p style={{textAlign:"left"}}>SHIPPING & BILLING ADDRESS <span>Tell us Where To Deliver<button onClick={handleShip}>{plus? "-":"+" }</button></span></p>
                    </div>
                    <div  style={plus?{display:"block"}:{display:"none"}}>
                        ...
                        <div className="five"><input onChange={handleAdd} name="country" style={{width:"82%"}} placeholder="Country"/> </div>
                            <div className="six">
                    ...
                    {/* ends here */}
                        <div className="one">
                        <p style={{textAlign:"left"}}>PAYMENT <span>How Would You Like To Pay<button onClick={handleCard}>{pay? "-":"+" }</button></span></p>
                          </div>
                ...
                <div className="amount">
                    ...
                    <p style={{textAlign:"left"}}>Cart Value <span>{oriP}</span></p>
                    <p style={{color:"#6C9D10",textAlign:"left"}}>Retail DisCount <span>{oriP-disP}</span></p>
                    <p>Delivery & Assembly Charges extra. Enter Pincode to Know</p>
                     <h4 style={{textAlign:"left"}}>Total <span>{disP}</span></h4>
                    </div>
                    <div>
                        <h5>No Cost EMI Available starting Rs4,334/month ,EMI Starting Rs1,224/month</h5>
